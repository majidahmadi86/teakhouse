    ...
    <Popover className={cn("relative", className)}>
      {({ close }) => (
        <>
          ...
          >
            <PopoverPanel className="absolute left-0 z-50 mt-2 w-auto rounded-2xl bg-white p-4 shadow-xl">
              <DayPicker
                mode="range"
                selected={selected}
                ...
                classNames={{
                  ...
                  caption_label: "font-display text-lg font-semibold text-navy",
                  ...
                  day_range_middle: "rounded-none bg-sky text-navy aria-selected:text-navy",
