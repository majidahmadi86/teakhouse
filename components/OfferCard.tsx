...
export function OfferCard({ n, large, className }: OfferCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "mt-4 font-display font-normal leading-none text-white transition-transform duration-300 group-hover:scale-110",
          large
      ...
      <span className="mt-5 inline-flex items-center text-sm font-bold text-white transition group-hover:gap-2">
        {t("off.bookOffer")}
      </span>
    </Link>
  );
